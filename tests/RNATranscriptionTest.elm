module RNATranscriptionTest exposing (tests)
...
tests =
    describe "RNATranscription"
        ...
        , test "complement should not be possible because of invalid nucleotide" <|
            \() -> Expect.equal (Err "P is not a valid nucleotide.") (toRNA "ACGPTGGBTCTTAA")
        ]
